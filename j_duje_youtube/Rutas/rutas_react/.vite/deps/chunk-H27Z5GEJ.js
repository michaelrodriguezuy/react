...
var Portal = React35.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React35.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React35.isValidElement(children)) {
      ...
      return React35.cloneElement(children, newProps);
    }
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React38.useContext(DropdownContext_default);
  if (menuContext === null) {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React41.useContext(DropdownContext_default)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted,
...
var Option = React47.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React47.memo(Option);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime25.jsx)(React50.Fragment, {
...
var Slider = React52.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime27.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime27.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime28.jsxs)(React52.Fragment, {
...
var TextareaAutosize = React70.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime43.jsxs)(React70.Fragment, {
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache ? (0, import_jsx_runtime44.jsx)(void 0, {
    value: cache,
    children
  }) : children;
}
...
function GlobalStyles(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(void 0, {
    styles: globalStyles
  });
}
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React74.useContext(void 0);
...
function GlobalStyles2({
  ...
  return (0, import_jsx_runtime46.jsx)(GlobalStyles, {
    styles: globalStyles
  });
}
true ? GlobalStyles2.propTypes = {
   ...
   * @ignore
   */
  defaultTheme: import_prop_types34.default.object,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  themeId: import_prop_types34.default.string
} : void 0;
...
function createBox(options = {}) {
  ...
  const Box2 = React76.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime47.jsx)(BoxRoot, _extends({
      as: component,
      ref,
...
function ThemeProvider(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(ThemeContext_default.Provider, {
    value: theme,
    children
  });
}
...
function ThemeProvider2(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(ThemeProvider_default, {
    theme: privateTheme,
    children: (0, import_jsx_runtime49.jsx)((void 0).Provider, {
      value: engineTheme,
      children
    })
  });
...
true ? ThemeProvider2.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types37.default.oneOfType([import_prop_types37.default.func, import_prop_types37.default.object]).isRequired,
  /**
   * The design system's unique id for getting the corresponded theme when there are multiple design systems.
   */
  themeId: import_prop_types37.default.string
} : void 0;
if (true) {
...
function createContainer(options = {}) {
  ...
  const Container2 = React84.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime53.jsx)(ContainerRoot, _extends({
        as: component,
        ownerState,
...
var _excluded32 = ["className", "children", "columns", "container", "component", "direction", "wrap", "spacing", "rowSpacing", "columnSpacing", "disableEqualOverflow", "unstable_level"];
...
function createGrid(options = {}) {
  ...
  const OverflowContext = React85.createContext(void 0);
  ...
  const Grid2 = React85.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React85.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime54.jsx)(GridRoot, _extends({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
      ...
      children: React85.Children.map(children, (child) => {
        if (React85.isValidElement(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = (0, import_jsx_runtime54.jsx)(OverflowContext.Provider, {
...
var _excluded33 = ["component", "direction", "spacing", "divider", "children", "className", "useFlexGap"];
...
function createStack(options = {}) {
  ...
  const Stack2 = React86.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
    ...
    return (0, import_jsx_runtime55.jsx)(StackRoot, _extends({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H27Z5GEJ.js.map
